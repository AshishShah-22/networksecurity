...
class DataIngestion:
    ...
    def export_data_into_feature_store(self,dataframe:pd.DataFrame):
        try:
            feature_store_file_path = self.data_ingestion_config.feature_store_directory
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Exited split_data_as_train_test methiod of Data_ingestion class")
            ...
            logging.info(f"Expoted train and test file path.")
